  ...
  outputs = inputs@{ flake-parts, ... }: flake-parts.lib.mkFlake { inherit inputs; } {
    ...
    perSystem = { pkgs, lib, buildGoModule, fetchFromGitHub, ... }: {
      packages = let buildGoModule = pkgs.buildGoModule; fetchFromGitHub = pkgs.fetchFromGitHub; in {
        nomad_1_5_1 = ((import ./nomad_1_5.nix) { inherit lib buildGoModule fetchFromGitHub; }).nomad_1_5_1;
        ...
        nomad_1_3_11 = ((import ./nomad_1_3.nix) { inherit lib buildGoModule fetchFromGitHub; }).nomad_1_3_11;
        nomad_1_3_10 = ((import ./nomad_1_3.nix) { inherit lib buildGoModule fetchFromGitHub; }).nomad_1_3_10;
        nomad_1_3_9 = ((import ./nomad_1_3.nix) { inherit lib buildGoModule fetchFromGitHub; }).nomad_1_3_9;
        ...
        consul_1_15_1 = ((import ./consul_1_15.nix) { inherit lib buildGoModule fetchFromGitHub; }).consul_1_15_1;
        consul_1_15_0 = ((import ./consul_1_15.nix) { inherit lib buildGoModule fetchFromGitHub; }).consul_1_15_0;

        consul_1_14_5 = ((import ./consul_1_14.nix) { inherit lib buildGoModule fetchFromGitHub; }).consul_1_14_5;
        ...
        consul_1_13_7 = ((import ./consul_1_13.nix) { inherit lib buildGoModule fetchFromGitHub; }).consul_1_13_7;
